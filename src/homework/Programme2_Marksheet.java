...
public class Programme2_Marksheet {
    public static void main(String[] args) {
        ...
        System.out.print("/nEnter student Name \t\t:\t");//input wizard
    ...
    public static String calculateResult(int mathMarks,int scienceMark,int englishMarks){
        if(mathMarks<35 ||scienceMark<35||englishMarks<35){
            return "FAIL";
        }else
            return "PASS";
    }
